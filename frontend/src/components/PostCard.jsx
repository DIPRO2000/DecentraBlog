  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <h2 className="text-2xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors duration-300">{post.title}</h2>
        <p className="text-sm text-slate-400 mb-4">
          By <span className="font-mono bg-slate-700 px-1.5 py-0.5 rounded-sm">{truncateAddress(post.author)}</span>
        </p>
